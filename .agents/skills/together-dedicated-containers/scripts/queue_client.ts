...
async function submitAndPoll(payload: Record<string, any>, priority: number = 1): Promise<any> {
...
async function submitMultiple(payloads: Record<string, any>[]): Promise<string[]> {
