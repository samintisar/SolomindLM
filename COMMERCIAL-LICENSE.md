...
- **No AGPL obligations** — No requirement to disclose your source code
- **SaaS freedom** — Build and sell hosted services without source code disclosure
- **Proprietary integration** — Embed into closed-source products and derivatives
- **Priority support** — Direct access to the development team
- **Custom development** — Request features and modifications
- **White-label rights** — Rebrand and resell as your own product

## Pricing

Commercial licenses are available on a per-project or per-organization basis.
...
- Whether you need custom modifications

We offer special pricing for early-stage startups and non-profits.
...
**Yes.** Contributing to the project does not require a commercial license.
...
For open-source questions, please open an issue on GitHub.

---

> **Disclaimer:** This page is a summary for informational purposes only and is not legal advice. For questions about your specific situation, consult a qualified legal professional.
