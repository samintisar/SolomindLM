...
export const audioOverviewGeneration = internalAction({
  ...
  handler: async (ctx, args) => {
    ...
    try {
      ...
      await ctx.runMutation(internal.studio._helpers.updateAudioOverviewStatus, {
        audioOverviewId,
        status: 'generating',
        metadata: {
          phase: 'initializing',
      ...
      await ctx.runMutation(internal.studio._helpers.initAudioOverviewMapPhase, {
        audioOverviewId,
      ...
      await ctx.runMutation(internal.studio._helpers.markAudioOverviewFailed, {
        audioOverviewId,
...
export const processAudioMapChunk = internalAction({
  ...
  handler: async (ctx, args) => {
    ...
    try {
      ...
      await ctx.runMutation(internal.studio._helpers.storeAudioOverviewMapResult, {
        audioOverviewId,
        chunkIndex,
...
export const finalizeAudioOverviewPhase = internalAction({
  ...
  handler: async (ctx, args) => {
    ...
    try {
      ...
      // Save results
      await ctx.runMutation(internal.studio._helpers.saveAudioOverviewResults, {
        audioOverviewId,
        audioUrl,
        transcript,
        metadata: {
      ...
      await ctx.runMutation(internal.studio._helpers.clearAudioOverviewMapData, { audioOverviewId });
