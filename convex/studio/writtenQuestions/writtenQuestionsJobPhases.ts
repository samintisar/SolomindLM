...
export async function runWrittenQuestionsGenerationPhase(
  ...
  args: WrittenQuestionsGenerationPhaseArgs,
    ...
    try {
      ...
      await ctx.runMutation(internal.studio.jobMutations.writtenQuestions.updateWrittenQuestionsStatus, {
        writtenQuestionId,
        status: 'generating',
        metadata: {
          phase: 'initializing',
      ...
      await ctx.runMutation(internal.studio.jobMutations.writtenQuestions.initWrittenQuestionsMapPhase, {
        writtenQuestionId,
      ...
      await ctx.runMutation(internal.studio.jobMutations.writtenQuestions.markWrittenQuestionsFailed, {
        writtenQuestionId,
...
export async function runProcessWrittenQuestionsMapChunkPhase(
  ...
  args: ProcessWrittenQuestionsMapChunkPhaseArgs,
    ...
    try {
      ...
      await ctx.runMutation(internal.studio.jobMutations.writtenQuestions.storeWrittenQuestionsMapResult, {
        writtenQuestionId,
        chunkIndex,
...
export async function runFinalizeWrittenQuestionsPhase(
  ...
  args: FinalizeWrittenQuestionsPhaseArgs,
    ...
    try {
      ...
      // Save results
      await ctx.runMutation(internal.studio.jobMutations.writtenQuestions.saveWrittenQuestionsResults, {
        writtenQuestionId,
      ...
      await ctx.runMutation(internal.studio.jobMutations.writtenQuestions.clearWrittenQuestionsMapData, { writtenQuestionId });
