...
export const flashcardGeneration = internalAction({
  ...
  handler: async (ctx, args) => {
    ...
    try {
      ...
      await ctx.runMutation(internal.studio._helpers.updateFlashcardStatus, {
        flashcardId,
        status: 'generating',
        metadata: {
          phase: 'initializing',
      ...
      await ctx.runMutation(internal.studio._helpers.initFlashcardMapPhase, {
        flashcardId,
      ...
      await ctx.runMutation(internal.studio._helpers.markFlashcardFailed, {
        flashcardId,
...
export const processFlashcardMapChunk = internalAction({
  ...
  handler: async (ctx, args) => {
    ...
    try {
      ...
      const flashcard = await ctx.runQuery(internal.studio.flashcards.index.getInternal, { id: flashcardId });
      if (!flashcard) {
      ...
      await ctx.runMutation(internal.studio._helpers.storeFlashcardMapResult, {
        flashcardId,
        chunkIndex,
      ...
      const updatedFlashcard = await ctx.runQuery(internal.studio.flashcards.index.getInternal, { id: flashcardId });
...
export const finalizeFlashcardPhase = internalAction({
  ...
  handler: async (ctx, args) => {
    ...
    try {
      ...
      // Save results
      await ctx.runMutation(internal.studio._helpers.saveFlashcardResults, {
        flashcardId,
      ...
      await ctx.runMutation(internal.studio._helpers.clearFlashcardMapData, { flashcardId });
