...
import { MAP_SYSTEM_PROMPT, MAP_PROMPTS, REDUCE_SYSTEM_PROMPT, REDUCE_PROMPTS } from '../../_agents/report/prompts';
...
2. "summary": The complete structured summary as described above`;
    ...
    const updatedReport = await ctx.runQuery(internal.studio.reports.index.getInternal, { id: reportId });
