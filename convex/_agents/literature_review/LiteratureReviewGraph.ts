...
export const literatureReviewWorkflow = workflow
  ...
  .handler(async (step, args) => {
    ...
    const searchResults = await step.runAction(internal.literatureReview.workflowSteps.searchPapers, {
      query: args.query,
    ...
    const deduped = await step.runAction(internal.literatureReview.workflowSteps.deduplicatePapers, {
