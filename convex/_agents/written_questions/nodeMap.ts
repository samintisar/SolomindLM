...
import { getMapPrompt, MAP_SYSTEM_PROMPT, type WrittenQuestionsResponse } from "./prompts.js";
...
export async function mapProcess(
  ...
  logger.phaseComplete("map_process", {
    ...
    outputPreview: previewQuestions
      .map((q: WrittenQuestion) => q.question.substring(0, 50))
      .join("; "),
  });
