...
export const mlExplanationFixtures: EvalFixture[] = [
  {
    ...
    question:
      "How does a random forest classifier inject randomness into its construction to create a diverse ensemble of trees?",
    expectedItems: [],
    expectedAnswer:
    ...
    expectedBehavior:
      "Must explain both mechanisms of randomness: bootstrap sampling for data, and selecting a random subset of features at each node. Should mention that this diversity aims to reduce overall model overfitting.",
  ...
  },
  {
    ...
    question:
      "How does content-based filtering approach the problem of predicting missing ratings in a recommender system?",
    expectedItems: [],
    expectedAnswer:
    ...
    expectedBehavior:
      "Must describe the creation of individual user profiles using item features, the training of a distinct supervised regression model for each user, and the application of these models to predict ratings for unrated items.",
    notebookId: "jd72h9qsq5zap11ede5k8rqkx585djmc",
