...
export const mlMultiDocFixtures: EvalFixture[] = [
  {
    ...
    question: "Summarize the evolution of text representations from Bag-of-Words to Large Language Models discussed in the sources.",
    expectedItems: [],
    expectedAnswer: "Bag-of-Words (BoW), implemented via CountVectorizer, is a simple frequency-based representation that creates sparse, high-dimensional vectors but ignores word order, context, and relationships between similar words. Word embeddings improve upon this by providing dense vector representations that mathematically capture contextual relationships and word meaning based on the distributional hypothesis. Sentence embeddings extend this to capture meaning at the sentence level using a single vector. Finally, Large Language Models (LLMs) scale these transformer-based embeddings to billions of parameters, enabling context-aware, dynamic representations that allow for complex reasoning and text generation.",
    expectedBehavior: "Must synthesize the progression of text representations across the NLP lectures. Watch for mentions of BoW limitations, the contextual nature of word/sentence embeddings, and the dynamic scaling and capabilities of LLMs.",
